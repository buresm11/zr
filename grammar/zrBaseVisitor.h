...
public:
  ...
  virtual antlrcpp::Any visitBoolExpression(zrParser::BoolExpressionContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitStringExpression(zrParser::StringExpressionContext *ctx) override {
    return visitChildren(ctx);
  }
